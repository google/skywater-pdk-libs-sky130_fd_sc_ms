...
`ifndef SKY130_FD_SC_MS__UDP_DFF_PR_V
`define SKY130_FD_SC_MS__UDP_DFF_PR_V
...
`ifdef NO_PRIMITIVES
`include "./sky130_fd_sc_ms__udp_dff_pr.blackbox.v"
`else
primitive sky130_fd_sc_ms__udp_dff$PR (
    Q    ,
    D    ,
    CLK  ,
    RESET
...
`endif  // SKY130_FD_SC_MS__UDP_DFF_PR_V
